...
public class TameAnimalTriggerHandler implements TriggerHandler<TameAnimalTrigger.TriggerInstance> {
    ...
    private static final Component TEXT_BEFORE = ModUtils.getScreenTranslated("trigger.tame_animal.before");
    private static final Component TEXT_BEFORE_WITH_CONDITIONS = ModUtils.getScreenTranslated("trigger.tame_animal.before.with_conditions");
    private static final Component TEXT_AFTER = ModUtils.getScreenTranslated("trigger.tame_animal.after");
    private static final Component TEXT_AFTER_WITH_CONDITIONS = ModUtils.getScreenTranslated("trigger.tame_animal.after.with_conditions");

    @Override
    public TriggerDisplayElement prepare(ResearchCriterion<TameAnimalTrigger.TriggerInstance> criterion) {
