...
public class ShotCrossbowTriggerHandler implements TriggerHandler<ShotCrossbowTrigger.TriggerInstance> {
    private static final Component ITEM_CONDITIONS_HEADER = ModUtils.getScreenTranslated("trigger.shot_crossbow.item");
    private static final Component PLAYER_CONDITIONS_HEADER = ModUtils.getScreenTranslated("trigger.player");
    private static final Component TEXT = ModUtils.getScreenTranslated("trigger.shot_crossbow");
    private static final Component TEXT_WITH_CONDITIONS = ModUtils.getScreenTranslated("trigger.shot_crossbow.with_conditions");
    private static final Component TEXT_SPECIFIC_BEFORE = ModUtils.getScreenTranslated("trigger.shot_crossbow.specific.before");
    private static final Component TEXT_SPECIFIC_BEFORE_WITH_CONDITIONS = ModUtils.getScreenTranslated("trigger.shot_crossbow.specific.with_conditions.before");
    private static final Component TEXT_SPECIFIC_AFTER = ModUtils.getScreenTranslated("trigger.shot_crossbow.specific.after");
    private static final Component TEXT_SPECIFIC_AFTER_WITH_CONDITIONS = ModUtils.getScreenTranslated("trigger.shot_crossbow.specific.with_conditions.after");

    @Override
    public TriggerDisplayElement prepare(ResearchCriterion<ShotCrossbowTrigger.TriggerInstance> criterion) {
